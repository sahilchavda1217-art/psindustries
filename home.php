...
header.scrolled {
    ...
    border-bottom-color: #CF4B00; /* Orange border on scroll */
...
.logo-frame {
    ...
    border: 2px solid #CF4B00; /* Orange border */
    flex-shrink: 0;
    position: relative;
    z-index: 1;
    transition: all 0.3s ease;
...
.tagline {
    ...
    padding-left: 5px;
    border-left: 3px solid #9CC6DB; /* Light blue accent */
    transition: all 0.3s ease;
    overflow: hidden;
}
...
<body>
                ...
                <ul class="nav-links">
                    ...
                    <li class="dropdown">
                        <a href="products.php">Product Range</a>
                            <div class="dropdown-content">
                                <a href="products.php?category=DTY+Machine">Double Density DTY Machine</a>
                                <a href="products.php?category=TFO+Machine">Two-for-One Machine</a>
                                <a href="products.php?category=Jari+Machine">Jari Machine</a>
    ...
    <div class="story-section">
        <div class="image-container">
            <span class="card-badge">Our Journey</span>
            <img src="TFO.jpg" alt="Our Journey" class="story-image">
            <div class="image-overlay">
                <h4>Since 1990</h4>
            </div>
        </div>
        <div class="story-content">
            <h3>How we Took Off</h3>
            <p class="story-text">Starting from a small workshop in 1990, we've grown into a leading manufacturer. Our commitment to quality and innovation has been the driving force behind our success...</p>
    ...
    <div class="story-section">
        <div class="image-container">
            <span class="card-badge">Process</span>
            <img src="jari.jpg" alt="Our Process" class="story-image">
            <div class="image-overlay">
        ...
        <div class="story-content">
            ...
            <p class="story-text">Using advanced CNC machinery and skilled craftsmanship, we deliver precision components. Our quality control ensures every product meets international standards...</p>
            <a href="#" class="read-more">Read More <i>→</i></a>
        </div>
    </div>
    ...
    <div class="story-section">
        <div class="image-container">
            <span class="card-badge">Excellence</span>
            <img src="3.jpg" alt="Our Excellence" class="story-image">
            <div class="image-overlay">
                <h4>Award Winning</h4>
            </div>
        </div>
        <div class="story-content">
            <h3>How we Excel</h3>
            <p class="story-text">Through continuous improvement and customer-focused approach, we've earned industry recognition. Our team's expertise ensures we stay ahead in technology...</p>
            <a href="#" class="read-more">Read More <i>→</i></a>
        </div>
    </div>
</div>
