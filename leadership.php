...
.leader-card:hover .image-gradient-overlay {
    opacity: 1;
}
...
.founder-card .position-badge {
    background: linear-gradient(135deg, #9CC6DB, #CF4B00);
}

.founder-card .leader-name {
    color: #9CC6DB;
}

.founder-card .leader-name:after {
    background: #CF4B00;
}
                ...
                <ul class="nav-links">
                    ...
                    <li class="dropdown">
                        <a href="#">Product Range</a>
                            <div class="dropdown-content">
                                <a href="DD.php">Double Density DTY Machine</a>
                                <a href="TFO.php">Two-for-One Machine</a>
    ...
    <div class="leadership-grid">
        <div class="leader-card founder-card">
            <div class="leader-image-container">
                <div class="position-badge">FOUNDER & CEO</div>
                <img src="TFO.jpg" alt="Mr. ABC - Founder & CEO" class="leader-image">
                <div class="image-gradient-overlay"></div>
            </div>
            <div class="leader-content">
                <h3 class="leader-name">Mr. ABC</h3>
                <div class="leader-title">Founder & Chief Executive Officer</div>
                <div class="leader-description">
                    The visionary leader who founded P S Industries with a dream to revolutionize precision engineering. With over 30 years of experience in manufacturing and industrial solutions, he continues to drive innovation and excellence.
                </div>
                <div class="leader-quote">
                    "Taking risks and pushing boundaries is what creates true innovation in engineering."
                </div>
            </div>
        </div>
        ...
        <div class="leader-card">
            <div class="leader-image-container">
                <div class="position-badge">PRODUCT HEAD</div>
                <img src="product.jpg" alt="Product Head" class="leader-image">
                <div class="image-gradient-overlay"></div>
            </div>
            <div class="leader-content">
                <h3 class="leader-name">Product Head Name</h3>
                <div class="leader-title">Head of Product Development</div>
                <div class="leader-description">
                    Responsible for overseeing all product development and ensuring our machines meet the highest standards of quality and innovation. With expertise in industrial machinery design and manufacturing processes.
                </div>
                <div class="leader-quote">
                    "Precision in engineering leads to perfection in manufacturing."
                </div>
            </div>
        </div>
