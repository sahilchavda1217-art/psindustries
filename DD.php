...
.product-image-container:hover {
    ...
    box-shadow: 0 20px 50px rgba(207, 75, 0, 0.3);
}
...
.image-caption {
    ...
    left: 0;
    right: 0;
    background: linear-gradient(to top, rgba(207, 75, 0, 0.9), transparent);
    color: white;
    padding: 25px 30px;
    text-align: left;
}
...
.inquire-btn {
    ...
    font-size: 1.1rem;
    transition: all 0.3s ease;
    border: 3px solid #9CC6DB;
    box-shadow: 0 8px 25px rgba(207, 75, 0, 0.25);
    position: relative;
    overflow: hidden;
}
...
.inquire-btn:hover {
    ...
    transform: translateY(-5px);
    box-shadow: 0 15px 35px rgba(207, 75, 0, 0.35);
    border-color: #CF4B00;
}
...
.modal-content {
    ...
    max-width: 500px;
    border-radius: 20px;
    box-shadow: 0 25px 60px rgba(207, 75, 0, 0.3);
    border: 3px solid #DDBA7D;
    overflow: hidden;
...
.submit-btn:hover {
    background: linear-gradient(135deg, #DDBA7D, #CF4B00);
    transform: translateY(-3px);
    box-shadow: 0 8px 20px rgba(207, 75, 0, 0.25);
}
...
<body>
                            ...
                            if(isset($_POST["submit"]))
                                {
                                    ...
                                    $query = "INSERT INTO inquirytb VALUES('$name','$email','$phone','$company','$product','$message')";
    ...
    <div class="container">
        ...
        <!-- Product Image with Inquire Button -->
        <div class="product-image-section">
            <div class="product-image-container">
                <img src="product.jpg" alt="Our Manufacturing Facility">
                <div class="image-caption">
                    <h3>State-of-the-Art Manufacturing Facility</h3>
                    <p>Advanced machinery and precision engineering for superior textile machinery</p>
                </div>
            </div>
            
            <div class="inquire-container">
                <button class="inquire-btn" id="inquire-btn">
        ...
        <div id="inquiry-modal" class="inquiry-modal">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="inquiry-form" id="inquiry-form" method="post" action="DD.php">
                        ...
                        <div class="form-group">
                            ...
                            <select id="product" name="product">
                                ...
                                <option value="Double Density DTY Machine">Double Density DTY Machine</option>
                                <option value="Two-for-One Machine">Two-for-One Machine</option>
                                <option value="Jari Machine">Jari Machine</option>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="message" name="message" required placeholder="Please provide details about your inquiry, specific requirements, or questions..."></textarea>
                        </div>
                        
                        <input type="submit" class="submit-btn" name="submit" value="Submit Inquiry"/>
                    </form>
                </div>
            </div>
        </div>
            ...
            if(isset($_POST["submit"]))
                {
                    ...
                    $q1 = "INSERT INTO inquiryTB (Name, Email, Phone, Company, Product) VALUES('$name','$email','$phone','$cname','$product')";
    ...
    <script>
        ...
        // Chatbot functionality (same as before, but updated with your company info)
        const chatbotKnowledge = {
            ...
            "inquiry": {
                "process": "You can submit an inquiry using the 'Inquire Now' button below our product images. Our team typically responds within 24 hours.",
                "support": "For immediate assistance, call 9909783819 or use our chatbot for quick answers."
            }
        };
        ...
        function processQuestion(question) {
            ...
            setTimeout(() => {
                ...
                else if (lowerQuestion.includes('inquiry') || lowerQuestion.includes('inquire') || lowerQuestion.includes('request')) {
                    response = chatbotKnowledge.inquiry.process + " " +
                              "Click the 'Inquire Now' button below our product images to submit your inquiry directly.";
                }
        ...
        // Auto-show notification dot after 10 seconds
        setTimeout(() => {
