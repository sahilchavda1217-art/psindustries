    ...
    <div class="container">
        ...
        <div class="product-image-section">
            <div class="product-image-container">
                <img src="TFP.jpg" alt="Our Manufacturing Facility">
        ...
        <div id="inquiry-modal" class="inquiry-modal">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="inquiry-form" id="inquiry-form" method="post" action="TFO.php">
                        ...
                        <button type="submit" class="submit-btn" name="submit">Submit Inquiry</button>
